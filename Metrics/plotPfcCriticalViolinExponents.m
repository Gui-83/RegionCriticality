function plotPfcCriticalViolinExponents(stats_list)
...
for stat = 1:n_stats
    ...
    x_pos = 1.192 + (-0.5:0.155:1.12).';
    %v = violinplot(Y, 'GroupByColor',group);
    v = violinplot(ones(size(Y)),Y, 'GroupByColor',group, 'DensityWidth',0.9);
    for i = 1 : numel(v)
...
saveFig(gcf,"/mnt/hubel-data-103/Guillaume/NRAvalanche/Figures/svg_Files/PfcViolinPlots_pBars",'svg') % file_path: 'aaa/vvv/file_name'